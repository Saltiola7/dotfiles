...
| --- | --- | --- | --- |
| AUTH-015-host-native-state | Routed mise installs, uv tools and Python runtimes, and PyCharm plugins through supported external paths; archived validated rollback state | 2026-08-09 | `3ead600` |
