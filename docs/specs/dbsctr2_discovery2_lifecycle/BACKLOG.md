...
| 24 | Retire unsupported OAuth Pro agents | high | done | 23 | OpenAI primary agents, model override, lifecycle artifacts, focused tests | OpenCode 1.17.20 OAuth filtering, PR #36694, and live OAuth rejection | no | Match selectable agents to actual ChatGPT OAuth behavior | S | Pro probe rejected; source, deployment, resolved config, and live agent checks passed |
