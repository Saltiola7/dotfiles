...
| OCP-10 | Retire unsupported Pro aliases and restore native Build | high | in_progress | OCP-9 | OpenAI provider override, native/custom primary agents, control-plane artifacts and tests | OpenCode 1.17.20 OAuth behavior, Plan handoff source, PR #36694, and live probes | no | Keep model exposure truthful and preserve supported Plan-to-Build execution | S | Pro probe rejected; fresh Build-GPT probe passed; focused tests and deployment pending |
