...
| OCP-11 | Transfer AI configuration ownership to dotfiles-ai | high | done | OCP-10 | personal source retirement and ownership contract | public dotfiles-ai v0.1.0 | no | Prevent two chezmoi sources from owning global AI configuration | M | Managed-target intersection absent; live OpenCode and Herdr healthy |
